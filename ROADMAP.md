...
- [ ] Clean up existing create-next-app boilerplate
- [ ] Set up Tailwind v4 theme (dark/light colors, spacing, typography)
- [ ] Define CSS custom properties for brand colors (cyan/teal accent palette)
- [ ] Configure fonts: Inter (body), JetBrains Mono (code)
- [ ] Build theme-toggle component (dark/light with localStorage persistence)
- [ ] Create reusable layout components: Container, Section, Grid
- [ ] Set up shadcn/ui with customized theme
